                ...
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <form  action="save-settings.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="website_name" value="<?php echo $row['sitename']; ?>" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label for="logo">Website Logo</label>
                            <input type="file" name="logo">
                            <img src="images/<?php echo $row['mainlogo']; ?>">
                            <input type="hidden" name="old_logo" value="<?php echo $row['mainlogo']; ?>" >
                        </div>
                        <div class="form-group">
